...
setwd( "C:/Users/Usuario/OneDrive/Facundo Vasquez/3_PostGraduateCourses/1_MCD_UAustral/11_LaboratorioI" )  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
setwd("C:/Users/Usuario/OneDrive/Facundo Vasquez/3_PostGraduateCourses/1_MCD_UAustral/11_LaboratorioI\\labo\\exp\\ST5210\\")   #Establezco el Working Directory DEL EXPERIMENTO
