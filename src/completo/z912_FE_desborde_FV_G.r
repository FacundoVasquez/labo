...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , fv_a_mcomisionesCliente_edad_2                           := mcomisiones / (cliente_edad^2)]
  dataset[ , fv_a_mcuentas_saldoMcomisiones                           := mcuentas_saldo / mcomisiones]
  dataset[ , fv_a_mcuentas_saldoMcomisiones_2                         := mcuentas_saldo / (mcomisiones^2)]
  dataset[ , fv_a_Master_mlimitecompraVisa_mlimitecompraCliente_edad  := ((Master_mlimitecompra+Visa_mlimitecompra)/cliente_edad)]
  dataset[ , fv_a_Master_mlimitecompraVisa_mlimitecompramComisiones   := ((Master_mlimitecompra+Visa_mlimitecompra)/mcomisiones)]
  dataset[ , fv_a_mpagomiscuentasMautoservicio                        := mpagomiscuentas / mautoservicio]
  dataset[ , fv_a_mautoservicioMcajeros_propios_descuentos_2          := mautoservicio / (mcajeros_propios_descuentos^2)]
  dataset[ , fv_d_mpagodeserviciosMpagomiscuentas                     := mpagodeservicios / mpagomiscuentas]
...
if( PARAM$Normi ) Normi( dataset )

if( PARAM$DummyByMode ) DummyByMode( dataset )

if (PARAM$TonyByMode ) TonyByMode( dataset )
