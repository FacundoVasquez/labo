...
modelo  <- rpart("clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 data = dtrain,
                 xval=       5,
                 cp=         -0.31693468075485,   #esto significa no limitar la complejidad de los splits
                 minsplit=   1583,     #minima cantidad de registros para que se haga el split
                 minbucket=  620,     #tamaño minimo de una hoja
