...
num_trees         <-  1223    #voy a generar 20 arboles, a mas arboles mas tiempo de proceso y MEJOR MODELO
feature_fraction  <-   0.5  #entreno cada arbol con solo 50% de las variables variables

set.seed(118249) #Establezco la semilla aleatoria, cambiar por SU primer semilla
